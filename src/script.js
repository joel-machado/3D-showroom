...
// gltfLoader.load('/model/metallic_showroom_gallery/scene.gltf', (gltf) => {
...
function init() {
  ...
  camera.position.set(3.9, -2.4, 0.9);
  camera.rotation.set(-0.9, -0.8, -0.8);
  ...
  const directionalLight = new THREE.DirectionalLight(0xffffff, 1.9); // Directional light
  directionalLight.position.set(15, 15, 15); // Set position
  scene.add(ambientLight, directionalLight); // Add lights to the scene
